<div
    ...
    <div class="bg-white lg:w-1/4 lg:h-3/6 lg:flex lg:flex-col lg:justify-start lg:mt-0 border rounded flex flex-col justify-center w-auto h-auto mt-4
        ...
        <ul class="mt-6 mr-4 flex flex-col">
            <li class="hover:bg-gray-500 px-2 py-2">
                <i class="fa fa-bookmark-o text-gray-400 ml-3"></i>
                <a href="#" class="text-gray-600 hover:text-white ">محصولات ارگانیک</a>
            </li>
            <li class="hover:bg-gray-500 px-2 py-2">
                <i class="fa fa-bookmark-o text-gray-400 ml-3"></i>
                <a href="#" class="text-gray-600  hover:text-white ">کشاورزی پایدار</a>
            </li>
            <li class="hover:bg-gray-500 px-2 py-2">
                <i class="fa fa-bookmark-o text-gray-400 ml-3"></i>
                <a href="#" class="text-gray-600 hover:text-white">زعفران ارگانیک</a>
            </li>
            <li class="hover:bg-gray-500 px-2 py-2">
                <i class="fa fa-bookmark-o text-gray-400 ml-3"></i>
                <a href="#" class="text-gray-600 hover:text-white">زرشک ارگانیک</a>
            </li>
        </ul>
        <!-- end menu -->
    </div>
