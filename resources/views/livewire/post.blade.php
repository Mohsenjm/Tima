<div class="mt-6 flex flex-col justify-center font-display">
    ...
    <div
        ...
        <!-- tab list -->
        <ul class="flex w-full justify-around bg-white lg:justify-center font-display">
            <li @click="openTab =1">
                <a :class="openTab === 1 ? activeClasses : inactiveClasses " href="#" class="text-regular text-gray-600">مشخصات</a>
            </li>
            <li @click="openTab =2" class="lg:mx-6">
                <a :class="openTab === 2 ? activeClasses : inactiveClasses " href="#" class="text-regular text-gray-600">نظر کاربران</a>
            </li>
            <li @click="openTab =3">
                <a :class="openTab === 3 ? activeClasses : inactiveClasses " href="#" class="text-regular text-gray-600">پرسش و پاسخ</a>
            </li>
        </ul>
        <!-- end tab list -->
                    ...
                    <div class="w-full lg:w-full mx-auto">
                        <form action="#" method="get">
                            <div class="flex flex-col justify-between mt-4">
                                ...
                                <div class="flex flex-col w-full lg:flex lg:flex-row md:flex md:flex-row justify-between">
                                    <!-- full-name -->
